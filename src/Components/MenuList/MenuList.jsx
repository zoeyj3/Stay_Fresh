...
function MenuList() {
  return (
    ...
    <div className="menulist">
      ...
      <a href="http://localhost:3000/myfridge/fridge" className="menulist__item">
        <img className="menulist__icon-img" src={fridgeicon} /> Fridge
      </a>
      < a href="http://localhost:3000/myfridge/freezer" className="menulist__item">
        <FontAwesomeIcon className="menulist__icon" icon={faSnowflake} />
        Freezer
      </a>
      <a href="http://localhost:3000/myfridge/pantry" className="menulist__item">
